  ...
  return(
    <div className="max-w-screen-xl mx-auto p-5">
        <nav className="flex justify-between items-center p-4 bg-blue-700 text-white rounded-lg">
            ...
            {user && <Image className="rounded-full" src={user.photoURL} width={50} height={50}/>}
        </nav>
        <section className="flex flex-col lg:flex-row justify-between items-center mt-12 space-y-8 lg:space-y-0 lg:space-x-8">
            <div className="max-w-lg space-y-4">
                ...
                <button className="bg-blue-700 text-white py-2 px-4 rounded-lg hover:bg-blue-800 transition">Get Started</button>
            </div>
        ...
        <section className="flex flex-row lg:flex-row items-center mt-16 space-y-8 lg:space-y-0 lg:space-x-8 p-8 bg-white rounded-lg shadow-lg">
            <button className="rounded-lg flex flex-col items-center justify-center w-full h-full bg-red-300 p-2">
              <FaCalendarCheck size={1/50}/>
            </button>
            <button className="rounded-lg flex flex-col items-center justify-center w-full h-full bg-red-300 p-2">
              <FaCalendarCheck/>
            </button>
